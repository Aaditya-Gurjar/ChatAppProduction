...
import InterviewQuestions from './pages/Login/InterviewQuestions';
    ...
    <ThemeProvider theme={{ mode, setMode }}>
      <ChatContextProvider>
        ...
        <Routes>
          ...
          <Route path="/login" element={user ? <Navigate to="/" replace={true} /> : <InterviewQuestions />} />
          <Route path="/getMoreQuestions" element={user ? <Navigate to="/" replace={true} /> : <Login />} />
